...
function todoCreate(title, objectlist) {
    ...
    for(let key in todos) {
        ...
        input.addEventListener("change", e => {
            if(e.target.checked) {
                _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.update(key, value.title, value.description, value.dueDate, value.priority, true);
                (0,_index__WEBPACK_IMPORTED_MODULE_2__.createContent)(todoCreate(title, objectlist));
            }
            else {
                _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.update(key, value.title, value.description, value.dueDate, value.priority, false);
                (0,_index__WEBPACK_IMPORTED_MODULE_2__.createContent)(todoCreate(title, objectlist));
            }
        });
        ...
        button.addEventListener("click", function(){
            ...
            x.addEventListener("click", function(){
                (0,_index__WEBPACK_IMPORTED_MODULE_2__.closeModal)();
            });
            ...
            duedatecontent.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate), "yyyy-MMM-do");
            ...
            ;(0,_index__WEBPACK_IMPORTED_MODULE_2__.createModalContent)(modaldiv);
        });
        div.appendChild(button);
        const date = document.createElement("p");
        date.classList.add("datewidth");
        date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate), "yyyy-MMM-do");
        ...
        edit.addEventListener("click", function(){
            (0,_index__WEBPACK_IMPORTED_MODULE_2__.createModalContent)((0,_form__WEBPACK_IMPORTED_MODULE_1__.createEditForm)(key));
        });
        trash.classList.add("todoicon");
        trash.addEventListener("click", function() {
            _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.remove(key);
    ...
    //If empty
    let projectslist = (0,_index__WEBPACK_IMPORTED_MODULE_2__.findProjects)();
    ...
    if(!maindiv.hasChildNodes() && hasproject) {
        ...
        deletebutton.addEventListener("click", function(){
            _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.removeProject(_index__WEBPACK_IMPORTED_MODULE_2__.noteorprojectkey);
            //Default to home page
            //Load Home tab as default
            (0,_index__WEBPACK_IMPORTED_MODULE_2__.defaultPage)();
            (0,_index__WEBPACK_IMPORTED_MODULE_2__.updatePage)();
        });
        maindiv.appendChild(emptyproject);
        maindiv.appendChild(text);
        maindiv.appendChild(deletebutton);
    }
    if(_index__WEBPACK_IMPORTED_MODULE_2__.noteorprojectkey != null) {
        if(_index__WEBPACK_IMPORTED_MODULE_2__.noteorprojectkey.includes("note")) {
            ...
            deletenote.addEventListener("click", function(){
                _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.removeNote(_index__WEBPACK_IMPORTED_MODULE_2__.noteorprojectkey);
                //Default to home page
                //Load Home tab as default
                (0,_index__WEBPACK_IMPORTED_MODULE_2__.defaultPage)();
                (0,_index__WEBPACK_IMPORTED_MODULE_2__.updatePage)();
            ...
            heading.textContent = "";
            let itemvalue = _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.notes[_index__WEBPACK_IMPORTED_MODULE_2__.noteorprojectkey];
            ...
            titlearea.addEventListener("keyup", function(){
                _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.updateNote(_index__WEBPACK_IMPORTED_MODULE_2__.noteorprojectkey, titlearea.value, descriptionarea.value);
            });
...
/* harmony import */ var _To_do_object__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./To_do_object */ "./src/To_do_object.js");
...
function createForm() {
    ...
    const list = (0,_index__WEBPACK_IMPORTED_MODULE_0__.findProjects)();
    for(let key in list) {
        let value = list[key];
    ...
    form.addEventListener("submit", function(){
        ...
        _To_do_object__WEBPACK_IMPORTED_MODULE_1__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_1__.toDoObject(titlevalue, descriptionvalue, datevalue, radiovalue, projectvalue));
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.updatePage)();
        //Reset form
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.createModalContent)(formDiv());
    });
...
function createProject() {
    ...
    form.addEventListener("submit", function(){
        let titlevalue = titleinput.value;
        _To_do_object__WEBPACK_IMPORTED_MODULE_1__.toDoLibrary.appendProject(new _To_do_object__WEBPACK_IMPORTED_MODULE_1__.projectObject(titlevalue));
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.updatePage)();
        //Reset form
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.createModalContent)(formDiv());
    });
...
function createNote() {
    ...
    form.addEventListener("submit", function(){
        let titlevalue = titleinput.value;
        let descriptionvalue = description.value;
        _To_do_object__WEBPACK_IMPORTED_MODULE_1__.toDoLibrary.appendNote(new _To_do_object__WEBPACK_IMPORTED_MODULE_1__.noteObject(titlevalue, descriptionvalue));
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.updatePage)();
        //Reset form
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.createModalContent)(formDiv());
    });
...
function createEditForm(key) {
    ...
    let itemvalue = _To_do_object__WEBPACK_IMPORTED_MODULE_1__.toDoLibrary.list[key];
    ...
    form.appendChild(datelabel);
    let selectdate = document.createElement("input");
    selectdate.setAttribute("value", (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(itemvalue.dueDate), "yyyy-MM-dd"));
    selectdate.required = true;
    selectdate.setAttribute("id", "selectdate");
    selectdate.setAttribute("type", "date");
    selectdate.classList.add("selectdate");
    ...
    form.addEventListener("submit", function(){
        ...
        _To_do_object__WEBPACK_IMPORTED_MODULE_1__.toDoLibrary.update(key, titlevalue, descriptionvalue, datevalue, radiovalue, itemvalue.completed);
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.updatePage)();
        //Reset form
        (0,_index__WEBPACK_IMPORTED_MODULE_0__.closeModal)();
    });
...
/* harmony export */   "noteorprojectkey": () => (/* binding */ noteorprojectkey),
...
(function checkLocaleStorage() {
    ...
    if(localStorage.length == 0) {
        ...
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Learn React", "Open Odin Project", today, "red"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.update("0", "Learn React", "Open Odin Project", today, "red", true);

        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Eat healthy", "Apple, Carrot", tomorrow, "yellow"));

        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Watch football", "With friends", threedays, "green"));

        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Code more", "CODE MORE!!!", yesterday, "red"));

        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Road trip", "To Mexico!", eightdays, "yellow"));

        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Dress up for the event", "Maybe that black suit", yesterday, "yellow"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.update("5", "Dress up for the event", "Maybe that black suit", yesterday, "yellow", true);

        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Date", "Dress up!", sevendays, "red"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.appendNote(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.noteObject("Gym routine", "Bench press: 60kg x 3, Deadlift: 100kg x 3 ..."));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.appendProject(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.projectObject("Game Project"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Start the project", "Get coding environment working", yesterday, "yellow", "Game Project"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.update("7", "Start the project", "Get coding environment working", yesterday, "yellow", true);
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Make art", "Likely some pixel art", tomorrow, "red", "Game Project"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Map builder", "Very simple map builder and save to JSON format", eightdays, "green", "Game Project"));
        _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.append(new _To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoObject("Watch TV", "Star wars", today, "green"));
...
function allOfThem() {
    return {..._To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.list};
}

//Return todos that are just completed
function completedThem() {
    const list = {..._To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.list};
    for(let key in list) {
        let value = list[key];
        if(!value.completed) {
            delete list[key];
...
function overdueThem() {
    ...
    for(let key in list) {
        let value = list[key];
        if(((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate)) == -1 || (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate))) || completedlist[key] == value) {
            delete list[key];
        }
    }
    return list;
...
function samedayThem() {
    ...
    for(let key in list) {
        let value = list[key];
        if(!(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate)) || completedlist[key] == value) {
            delete list[key];
        }
    }
    return list;
...
function weekThem() {
    ...
    for(let key in list) {
        let value = list[key];
        if(((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate)) == 1 || (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), {weeks: 1,}), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate)) == -1) || completedlist[key] == value || (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value.dueDate))) {
            delete list[key];
        }
    }
    return list;
...
function findProjects() {
    const list = {..._To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.projects};
    return list;
}

//Return list of notes
function findNotes() {
    const list = {..._To_do_object__WEBPACK_IMPORTED_MODULE_0__.toDoLibrary.notes};
    return list;
}
...
function createSidebarProjects() {
    ...
    for(let key in list) {
        ...
        li.addEventListener("click", function(){
            ...
            createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)(value.title, projectThem));
        });
        ul.appendChild(li);
    }
...
function createSidebarNotes() {
    ...
    for(let key in notelist) {
        ...
        li.addEventListener("click", function(){
            ...
            noteorprojectkey = key;
            createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)(value.title, returnempty));
        });
        ul.appendChild(li);
    }
    projectdiv.appendChild(ul);
...
document.querySelector(".plussign").addEventListener("click", function(){
    createModalContent((0,_form__WEBPACK_IMPORTED_MODULE_2__.formDiv)());
});
...
function updatePage() {
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)(updateTitle, updatefunction));
    createSidebarProjects();
    createSidebarNotes();
}
...
function defaultPage() {
    ...
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)("TO-DO", allOfThem));
    updateTitle = "TO-DO";
...
document.querySelector(".completedbutton").addEventListener("click", function() {
    noteorprojectkey = null;
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)("Completed", completedThem));
...
document.querySelector(".overduebutton").addEventListener("click", function() {
    noteorprojectkey = null;
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)("Overdue", overdueThem));
    updateTitle = "Overdue";
...
document.querySelector(".todaybutton").addEventListener("click", function() {
    noteorprojectkey = null;
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)("Today", samedayThem));
    updateTitle = "Today";
...
document.querySelector(".weekbutton").addEventListener("click", function() {
    noteorprojectkey = null;
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__.todoCreate)("In a Week", weekThem));
