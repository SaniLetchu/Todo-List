...
function todoCreate(title, objectlist) {
    ...
    for(let key in todos) {
        ...
        trash.addEventListener("click", function() {
            ...
            (0,_index__WEBPACK_IMPORTED_MODULE_1__.createContent)(todoCreate("Home of To-Dos", objectlist));
        });
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/differenceInWeeks/index.js");
...
function overdueThem() {
    ...
    for(let key in list) {
        let value = list[key];
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(value.dueDate)) == -1) {
            delete list[key];
        }
    }
    return list;
...
function samedayThem() {
    ...
    for(let key in list) {
        let value = list[key];
        if(!(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(value.dueDate))) {
            delete list[key];
        }
    }
    return list;
...
function weekThem() {
    ...
    for(let key in list) {
        let value = list[key];
        if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(value.dueDate)) == 1 || (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(value.dueDate)) != 1) {
            delete list[key];
        }
    }
    return list;
...
createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__["default"])("Home of To-Dos", allOfThem));
...
document.querySelector(".weekbutton").addEventListener("click", function() {
    createContent((0,_content__WEBPACK_IMPORTED_MODULE_1__["default"])("Week", weekThem));
});
